                                ...
                                <div class="widget-body">
                                    <ul class="filter-category filter-overflow">
                                        @foreach ($categories as $item)
                                            <li>
                                                <a href="{{ route('product.by.category', $item->slug) }}" class="category-link" data-slug="{{ $item->slug }}"><i class="las la-angle-right"></i>
                                                    {{ __($item->name) }} </a>
                                            </li>
                                        @endforeach
                                    </ul>
...
@push('script')
    ...
    fetchProducts();
            ...
            function fetchProducts(url = `{{ $request->fullUrl() }}`, data = null) {
                ...
                if($('.filter-category a.active').length) {
        params.set('category', $('.filter-category a.active').data('slug'));
    }
